...
/* Define to 1 if you have the declaration of `UCT_CB_FLAG_SYNC', and to 0 if
   you don't. */
#define HAVE_DECL_UCT_CB_FLAG_SYNC 0
...
#define MCA_io_romio321_COMPLETE_CONFIGURE_FLAGS " FROM_OMPI=yes CC='gcc' CFLAGS='-O3 -DNDEBUG -finline-functions -fno-strict-aliasing -mcx16 -pthread -D__EXTENSIONS__' CPPFLAGS='-I/home/ubuntu/pkg/openmpi-4.0.1-build/opal/mca/event/libevent2022/libevent/include -I/home/ubuntu/pkg/openmpi-4.0.1-source/opal/mca/event/libevent2022/libevent -I/home/ubuntu/pkg/openmpi-4.0.1-source/opal/mca/event/libevent2022/libevent/include -I/home/ubuntu/pkg/openmpi-4.0.1-build/opal/mca/hwloc/hwloc201/hwloc/include -I/home/ubuntu/pkg/openmpi-4.0.1-source/opal/mca/hwloc/hwloc201/hwloc/include  ' FFLAGS='' LDFLAGS=' ' --enable-shared --disable-static  --prefix=/home/ubuntu/pkg/openmpi-4.0.1 --disable-aio --disable-weak-symbols --enable-strict --disable-f77 --disable-f90"
...
#define OPAL_PACKAGE_STRING "Open MPI ubuntu@f1b428dfda21 Distribution"
